...
const stats = [
  { value: 120, suffix: '+', label: 'Audience events delivered', description: 'across South London schools, colleges, and civic venues' },
  ...
  { value: 15,  suffix: '+', label: 'Years of lived practice',   description: 'informing every element of the framework\'s design' },
];
